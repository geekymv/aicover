      ...
      switch (payload.type) {
        ...
        switch (payload.type) {
            case "payment.succeeded":
              ...
              const created_at = paymentDataResp.created_at;
              const order_no = paymentDataResp.metadata.orderNo;
              
              console.log("update order status start: ", order_no, created_at);
              updateOrderStatus(order_no, 2, created_at);
              console.log("update order status end: ", order_no, created_at);
